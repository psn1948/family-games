  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center py-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-1">🎲 Family Games</h1>
        <p className="text-gray-500">Track scores for your family game nights</p>
      </div>
      ...
      {activeSession ? (
        ...
        >
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              <p className="text-indigo-200 text-sm font-medium">Active Game</p>
              <h2 className="text-xl font-bold mt-0.5">{activeGame?.name ?? 'Unknown'}</h2>
              ...
              <p className="text-indigo-200 text-xs mt-2">
                {activeSession.rounds.length} round{activeSession.rounds.length !== 1 ? 's' : ''} played
              </p>
            </div>
      ...
      <div className="grid grid-cols-3 gap-4 text-center">
        ...
        <div className="card p-4">
          ...
          <p className="text-xs text-gray-500 mt-1">Sessions Played</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link to="/members" className="card p-4 hover:bg-indigo-50 transition-colors group text-center">
          ...
          <p className="text-sm font-medium text-gray-700 group-hover:text-indigo-700">Manage Members</p>
        </Link>
        <Link to="/games" className="card p-4 hover:bg-indigo-50 transition-colors group text-center">
          <p className="text-2xl mb-1">🃏</p>
          <p className="text-sm font-medium text-gray-700 group-hover:text-indigo-700">Manage Games</p>
        </Link>
      </div>
    </div>
  )
